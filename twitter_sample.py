...
import tqdm
import pymongo
from config.config import BEARER_TOKEN  # Twitter TOKEN 정보 불러오기 (발급 필요, 링크: https://developer.twitter.com/)
...
for line in tqdm.tqdm(response.iter_lines(), mininterval=10):
    if line:
